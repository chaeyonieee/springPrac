...
public class MemberDAO {
	...
	/*
	 * public String selectName() { sqlMapper = getInstance(); SqlSession session =
	 * sqlMapper.openSession(); String name =
	 * session.selectOne("mapper.member.selectName"); return name; } public String
	 * selectPwd() { sqlMapper = getInstance(); SqlSession session =
	 * sqlMapper.openSession(); String pwd =
	 * session.selectOne("mapper.member.selectPwd"); return pwd; }
	 */
	...
	public List<MemberVO> searchMember(MemberVO memberVO){
		sqlMapper = getInstance();
		SqlSession session = sqlMapper.openSession();
		List list= session.selectList("mapper.member.foreachSelect",memberVO);
		return list;
	}
