...
function backToList(obj){ <%-- 자바스크립트 function --%>
	obj.action = "${contextPath}/board61/listArticles.do";
	obj.submit();
}
...
function fn_modify_article(obj){
	obj.action = "${contextPath}/board61/modArticle.do";
	obj.submit();
}
...
<tr id="tr_btn">
 <td colspan="2" align="center">
  ...
  <input type="button" value="삭제하기" onClick="fn_remove_article('${contextPath}/board61/removeArticle.do',${article.articleNO})">
  <input type="button" value="리스트로 돌아가기" onClick="backToList(this.form)">
  <input type="button" value="답글쓰기" onClick="fn_reply_form('${contextPath}/board61/replyForm.do',${article.articleNO})">  
 </td>
</tr>
</table>
</form>
