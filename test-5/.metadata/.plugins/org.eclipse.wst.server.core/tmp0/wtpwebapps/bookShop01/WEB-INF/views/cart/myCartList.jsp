...
<c:set  var="totalGoodsNum" value="${cartMap.totalGoodsNum}" />  <!--주문 개수 -->
<c:set  var="totalDeliveryPrice" value="${cartMap.totalDeliveryPrice}" /> <!-- 총 배송비 --> 
<c:set  var="totalDiscountedPrice" value="${cartMap.totalDiscountedPrice}" /> <!-- 총 할인금액 -->
<head>
